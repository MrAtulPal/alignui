...
DesignLatch is a CLI-first design compliance tool for comparing expected design token values with computed styles from a live site.

Public docs: https://mratulpal.github.io/alignui/
Repository: https://github.com/MrAtulPal/alignui
Package: `@designlatch/cli`

## What v1 does

- validates `.designlatch.json`, `tokens.json`, and `snapshots.json`
...
- serves the report locally with `designlatch serve`
